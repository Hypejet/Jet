...
/**
 * Represents {@linkplain JsonSerializer a json serializer}, which serializes a {@linkplain ServerListPing.PingPlayer
 * server list ping player} to {@linkplain JsonElement a json element}.
 *
 * @since 1.0
 * @author Codestech
