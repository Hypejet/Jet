package net.hypejet.jet.server.network.packet.client.reader.handshake;

import io.netty.buffer.ByteBuf;
import net.hypejet.jet.data.codecs.util.mapper.Mapper;
import net.hypejet.jet.network.packet.client.handshake.ClientHandshakePacket;
import net.hypejet.jet.network.packet.client.handshake.ClientHandshakePacket.HandshakeIntent;
