...
public final class ServerSynchronizePositionPlayPacketWriter
    ...
    public void write(@NonNull ByteBuf buf, @NonNull JetRegistryManager registryManager,
                      @NonNull ServerSynchronizePositionPlayPacket object) {
        VarIntNetworkCodec.INSTANCE.write(buf, registryManager, object.identifier());
        ...
        VectorNetworkCodec.INSTANCE.write(buf, registryManager, object.deltaMovement());

        buf.writeFloat(position.yaw());
        buf.writeFloat(position.pitch());

        RELATIVE_FLAGS_WRITER.write(buf, registryManager, object.relativeFlags());
    }
    ...
    private static final class RelativeFlagCollectionNetworkWriter implements NetworkWriter<Collection<RelativeFlag>> {
        ...
        public void write(@NonNull ByteBuf buf,
                          ...
                          @NonNull Collection<RelativeFlag> object) {
            int value = 0;
