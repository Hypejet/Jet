...
public final class ServerUpdateLightPlayPacketWriter implements NetworkWriter<ServerUpdateLightPlayPacket> {
    ...
    @Override
    public void write(@NonNull ByteBuf buf, @NonNull ServerUpdateLightPlayPacket object) {
        VarIntChunkPositionNetworkWriter.INSTANCE.write(buf, object.position());
        LightSerializationDataNetworkWriter.INSTANCE.write(buf, object.data());
    }
}