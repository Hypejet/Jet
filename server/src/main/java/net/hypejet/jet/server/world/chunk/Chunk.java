 ...
 * @param heightmaps a binary tag that contains heightmaps that the chunk should have
 ...
 * @see ???
 */
public record Chunk(int chunkX, int chunkZ, @NotNull BinaryTag heightmaps, @NotNull List<ChunkSection> sections,
                    @NotNull Set<BlockEntity> blockEntities, @NotNull LightData lightData) {
    /**
