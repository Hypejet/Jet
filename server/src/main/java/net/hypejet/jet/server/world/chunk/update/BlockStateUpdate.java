 ...
 *
 * @param blockX a chunk-relative {@code X} coordinate value where the change should be made
 * @param blockY an absolute {@code Y} coordinate value where the change should be made
 * @param blockZ a chunk-relative {@code Z} coordinate value where the change should be made
