...
/**
 * Represents an update of {@linkplain BlockState a block state} that should be made
 * in {@linkplain net.hypejet.jet.server.world.chunk.Chunk chunk} at a coordinate with values specified.
 *
 ...
 * @since 1.0
 */
public record BlockStateUpdate(@NonNull ChunkRelativePosition position, @NonNull BlockState blockState) {
    /**
