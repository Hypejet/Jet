...
public final class JsonUtil {
    ...
    /**
     * Gets a string from a {@linkplain JsonObject json object}, throws an exception if the {@linkplain JsonElement
    ...
    public static @NonNull String getRequiredString(@NonNull String name, @NonNull JsonObject object) {
        ...
        JsonElement element = Objects.requireNonNull(object.get(name),
                "The plugin metadata does not contain a required property with name of \"" + name + "\"");
        return element.getAsString();
    }

    /**
     * Gets a boolean from a {@linkplain JsonObject json object}. Uses a default value if the {@linkplain JsonElement
     * json element} is null.
     *
