...
import net.hypejet.jet.server.network.protocol.codecs.registry.tag.TagNetworkWriter;
import net.hypejet.jet.server.test.network.protocol.codecs.NetworkCodecTestUtil;
import net.kyori.adventure.key.Key;
import org.junit.jupiter.api.Test;

/**
 * Represents a test of reading and writing of a {@linkplain TagNetworkWriter tag network codec}.
 *
 * @since 1.0
 * @author Codestech
 * @see TagNetworkWriter
 */
public final class TagNetworkWriterTest {
    @Test
    public void test() {
        NetworkCodecTestUtil.test(
                TagNetworkWriter.instance(),
