...
/**
 * Represents a test of reading and writing of {@linkplain TagRegistryNetworkWriter tag registry network codec}.
 *
 * @since 1.0
 * @author Codestech
 * @see TagRegistryNetworkWriter
 */
public final class TagMinecraftRegistryNetworkCodecTest {
    @Test
    public void test() {
        NetworkCodecTestUtil.test(
                TagRegistryNetworkWriter.instance(),
