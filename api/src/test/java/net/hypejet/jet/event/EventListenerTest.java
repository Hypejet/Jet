...
/**
 * Represents a test of {@linkplain EventListener an event listener}.
 *
 * @since 1.0
 */
public final class EventListenerTest {
    ...
    public void testListenerProperties() {
        ...
        EventListener<?> listener = new EventListener<>(event -> {}, eventClass, priority);
    ...
    public void testListenerCalling() {
        ...
        EventListener<String> listener = new EventListener<>(event -> called.set(true), String.class);
    ...
    public void testListenerEligible() {
        EventListener<String> listener = new EventListener<>(event -> {}, String.class, event -> event.equals("A"));
