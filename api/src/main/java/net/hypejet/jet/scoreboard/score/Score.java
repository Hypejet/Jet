 ...
 * @param displayName a text that should be displayed instead of the name of the entity owning the score when their
 *                    name is displayed in context of scoreboards, {@code null} if the entity name should be used
 *                    instead
