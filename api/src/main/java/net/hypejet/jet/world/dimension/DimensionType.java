package net.hypejet.jet.world.dimension;
 ...
 * @param logicalHeight the maximum height to which chorus fruits and nether portals can bring players within
...
public record DimensionType(@Nullable Long fixedTime, boolean hasSkyLight, boolean hasCeiling,
                            boolean ultraWarm, boolean natural, double coordinateScale,
                            boolean bedWorks, boolean respawnAnchorWorks, int minY, int height,
                            int logicalHeight, @NonNull Key infiniburn, @NonNull Key effects,
                            float ambientLight, @Nullable Integer cloudHeight,
    ...
    /**
     * Monster settings of a {@linkplain DimensionType dimension type}.
     *
     ...
     * @since 1.0
     */
    public record MonsterSettings(boolean piglinSafe, boolean hasRaids, @NonNull IntProvider spawnLightTest,
