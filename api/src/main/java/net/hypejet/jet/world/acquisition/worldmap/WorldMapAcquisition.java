...
public interface WorldMapAcquisition extends Acquisition {
     ...
     *
     * @param position the block position
     * @return the block entity, {@code null} if the chunk has not been loaded or the block does not have
     *         a block entity
     * @since 1.0
     */
    @Nullable BlockEntity getOptionalBlockEntity(@NonNull BlockPosition position);
