...
/**
 * A shirek {@linkplain Particle particle}.
 *
 * @since 1.0
 * @see Particle
 */
...
@NullMarked
public interface ShirekParticle extends Particle {
    /**
    ...
    /**
     * A {@linkplain Particle.Builder particle builder} of a {@linkplain ShirekParticle shirek particle}.
     *
     ...
     */
    interface Builder<P extends ShirekParticle, B extends Builder<P, B>> extends Particle.Builder<P> {
        /**
