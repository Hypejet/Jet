...
/**
 * Represents {@linkplain ServerPacket a server packet}, which provides information about the server and world
 * that a client joins to.
 *
 * @param entityId an entity identifier of the player joining
 * @param hardcore whether the game has hardcore enabled
 * @param dimensions keys of all dimensions on the server
 * @param maxPlayers a maximum amount of players of the server
...
public record ServerJoinGamePlayPacket(
    ...
    /**
     * Represents a death location of {@linkplain Player a player}.
     *
    ...
    public record DeathLocation(@NonNull Key deathDimensionName, @NonNull BlockPosition deathPosition) {
        ...
        public DeathLocation {
            NullabilityUtil.requireNonNull(deathDimensionName, "death dimension name");
