 ...
 */
@NullMarked
public record JsonBlock(Set<Key> requiredFeatureFlags,
                        int defaultBlockStateId, ImmutableIntArray blockStateIds,
                        Map<String, JsonStateProperty> blockStateProperties) {
    /**
