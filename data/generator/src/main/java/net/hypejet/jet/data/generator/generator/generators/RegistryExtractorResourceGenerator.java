...
public final class RegistryExtractorResourceGenerator<T> implements ResourceGenerator {
     ...
     * @param path a relative classpath of a file that should have the output generated by the generator
     * @since 1.0
     */
    public RegistryExtractorResourceGenerator(@NonNull RegistryExtractor<T> registryExtractor,
                                              @NonNull RegistryAccess registryAccess, @NonNull String path) {
